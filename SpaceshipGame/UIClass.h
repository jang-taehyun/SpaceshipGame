...
namespace UI
{
	...
	public:
		...
		virtual UINT GetUIState() const override { return m_State; }
		...
		virtual float GetDepth() const override { return m_Depth; }

		virtual void SetUIState(UIState state, bool IsActive) override;
		virtual void SetUITextureID(Graphic::Texture::UITextureID ID) override { m_UITextureID = ID; }
		...
		virtual void SetDepth(float depth) override { m_Depth = depth; }
