...
namespace Graphic
{
	namespace Texture
	{
		...
		public:
			...
			void RenderText(const std::wstring& text, Font::ID fontID, DirectX::XMFLOAT2 pos, DirectX::XMFLOAT4 color = DirectX::XMFLOAT4(1.f, 1.f, 1.f, 1.f), float rot = 0.f, DirectX::XMFLOAT2 origin = DirectX::XMFLOAT2(0.f, 0.f), float scale = 1.f);
