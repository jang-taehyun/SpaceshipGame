...
namespace Graphic
{
	namespace Texture
	{
		...
		public:
			...
			void RenderBackground(ID3D11ShaderResourceView* texture, DirectX::XMFLOAT4 color = DirectX::XMFLOAT4(1.f, 1.f, 1.f, 1.f), DirectX::XMFLOAT2 scale = DirectX::XMFLOAT2(1.f, 1.f));
