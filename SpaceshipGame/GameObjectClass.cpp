...
Object::GameObjectClass::GameObjectClass(Graphic::Model::ID ModelID, std::unique_ptr<IObjectClass> collision) : m_Collision(std::move(collision)), m_ModelID(ModelID) {}
