...
namespace Text
{
	...
	{
	public:
		TextClass(const std::wstring& text, DirectX::XMFLOAT2 pos, DirectX::XMFLOAT4 color = DirectX::XMFLOAT4(1.f, 1.f, 1.f, 1.f), FontID FontID = FontID::Default);
		virtual ~TextClass() = default;

		virtual inline const std::wstring& GetText() const override { return m_Text; }
		virtual inline FontID GetFontID() const override { return m_FontID; }
		...
		virtual inline void SetFontID(FontID id) override { m_FontID = id; }
