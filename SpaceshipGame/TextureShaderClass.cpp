...
{
	return InitializeShader(Device, hwnd, _T("../Engine/texture.vs"), _T("../Engine/texture.ps"));
}
...
bool TextureShaderClass::InitializeShader(ID3D11Device* Device, HWND hwnd, const TCHAR* vsFileName, const TCHAR* psFileName)
{
...
void TextureShaderClass::OutputShaderErrorMessage(ID3D10Blob* ErrorMessage, HWND hwnd, const TCHAR* ShaderFileName)
{
