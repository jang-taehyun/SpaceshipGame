...
{
	return InitializeShader(Device, hwnd, _T("../Engine/multitexture.vs"), _T("../Engine/multitexture.ps"));
}
...
bool MultiTextureShaderClass::Render(ID3D11DeviceContext* DeviceContext, int IndexCount, DirectX::XMMATRIX WorldMatrix, DirectX::XMMATRIX ViewMatrix, DirectX::XMMATRIX ProjectionMatrix, ID3D11ShaderResourceView** TextureArray)
{
...
bool MultiTextureShaderClass::InitializeShader(ID3D11Device* Device, HWND hwnd, const TCHAR* vsFileName, const TCHAR* psFileName)
{
...
void MultiTextureShaderClass::OutputShaderErrorMessage(ID3D10Blob* ErrorMessage, HWND hwnd, const TCHAR* ShaderFileName)
{
...
bool MultiTextureShaderClass::SetShaderParameters(ID3D11DeviceContext* DeviceContext, DirectX::XMMATRIX WorldMatrix, DirectX::XMMATRIX ViewMatrix, DirectX::XMMATRIX ProjectionMatrix, ID3D11ShaderResourceView** TextureArray)
{
	// 행렬들을 HLSL에 맞게 변환 //
...
void MultiTextureShaderClass::RenderShader(ID3D11DeviceContext* DeviceContext, int IndexCount)
{
	...
	// pixel shader에서 사용할 sampler state 설정 //
